  ...
  it('Should show all articles correctly', () => {
    ...
    cy.get('div.article-preview')
      ...
      .should(
        'have.attr',
        'src',
        'https://media-exp1.licdn.com/dms/image/C4E03AQF5zycBQzgfTA/profile-displayphoto-shrink_800_800/0/1597090855757?e=1638403200&v=beta&t=Nq41Ez9-mMVEcxlMONwX-_fNjFWjpkryPo-FthtJBWg'
      )
